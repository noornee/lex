...
function AttachEvents() {
    document.querySelectorAll("div.vplayable").forEach(element => {
        if (!element.hasAttribute("lex-elistener-attached"))
        {
            ...
            element.setAttribute("lex-elistener-attached", "")
        }
    });
}
...
function AttachGallery() {
    document.querySelectorAll(".vgallery").forEach(element => {
        if (!element.hasAttribute("lex-gallerynav-attached"))
        {
            let indx = 0;
            ...
            element.setAttribute("lex-gallerynav-attached", "")
        }
    })
}
